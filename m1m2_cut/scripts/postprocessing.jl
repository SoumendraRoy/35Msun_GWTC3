...
pe_table = far_cut(mass_cut(all_pe))

## Check number of events
n0p1, n0p5, n0p9 = length(groupby(far_cut(mass_cut(all_pe, thresh=0.1)), :gwname)), length(groupby(far_cut(mass_cut(all_pe, thresh=0.5)), :gwname)), length(groupby(far_cut(mass_cut(all_pe, thresh=0.9)), :gwname))
...
pe = far_cut(mass_cut(all_pe, thresh=0.5))
